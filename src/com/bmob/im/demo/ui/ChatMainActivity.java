...
public class ChatMainActivity extends ActivityBase implements EventListener{
	...
	public void onAddUser(BmobInvitation message) {
		...
		if(currentTabIndex==1){
			...
			BmobNotifyManager.getInstance(this).showNotify(isAllow, isAllow, R.drawable.ic_launcher, tickerText, message.getFromname(), tickerText.toString(),NewFriendActivity.class);
		}
	}
